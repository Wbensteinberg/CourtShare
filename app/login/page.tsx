              ...
              <div className="text-center pt-2">
                ...
                <div className="border-t border-slate-700 pt-2 space-y-1">
                  ...
                  <p className="text-slate-500 text-xs">
                    <a href="/terms" className="text-emerald-400/80 hover:text-emerald-300 hover:underline">Terms</a>
                    {" · "}
                    <a href="/privacy" className="text-emerald-400/80 hover:text-emerald-300 hover:underline">Privacy</a>
                  </p>
                </div>
              </div>
            </form>
